$(function () {
  ...
  $("#updateSave").click(function () {
    ...
    $.ajax({
      url: "https://freetestapi.com/api/v1/cats" + id,
...
function handleUpdate() {
  ...
  $.get("https://freetestapi.com/api/v1/cats/1" + id, function (
    response
  ) {
...
function addRecipe() {
  ...
  $.ajax({
    url: "https://freetestapi.com/api/v1/cats?limit=5",
    method: "POST",
    data: { isUser, fullName },
    success: function (response) {
      console.log(response);
...
function handleDelete() {
  ...
  console.log(id);
  $.ajax({
    url: "https://freetestapi.com/api/v1/cats?search=[query]" + id,
    method: "DELETE",
    success: function () {
      loadRecipies();
    }
...
function loadRecipies() {
  $.ajax({
    url: "https://freetestapi.com/api/v1/cats?sort=name&order=dec",
    method: "GET",
